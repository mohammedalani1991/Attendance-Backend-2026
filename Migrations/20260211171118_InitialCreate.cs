        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepartmentId = table.Column<int>(type: "INTEGER", nullable: false),
                    MarkedUnpaidAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Notes = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnpaidStudents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnpaidStudents_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "DepartmentId", "PasswordHash", "Role", "Username" },
                values: new object[] { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "$2a$11$MsFRQdgIUvHi5OYhHZ.kr.kwPnopjA6pMjpoGcGesOYfZW51/gunC", 1, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnpaidStudents_DepartmentId",
                table: "UnpaidStudents",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_UnpaidStudents_StudentId_DepartmentId",
                table: "UnpaidStudents",
